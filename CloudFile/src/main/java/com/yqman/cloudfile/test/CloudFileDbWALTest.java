...
public class CloudFileDbWALTest extends BaseSQLiteDatabase {
    private static final String DATABASE_NAME = "evan_cloud_file_wal_test.db";
    private static final int DATABASE_VERSION = 1;

    public CloudFileDbWALTest(Context context) {
