...
public class CloudFileDbNormalTest extends BaseSQLiteDatabase {
    private static final String DATABASE_NAME = "evan_cloud_file_normal_test.db";
    private static final int DATABASE_VERSION = 1;

    public CloudFileDbNormalTest(Context context) {
